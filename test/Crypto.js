...
describe("dpay.auth: Crypto", function() {
...
describe("dpay.auth: derives", ()=> {

    let one_time_private = PrivateKey.fromHex("8fdfdde486f696fd7c6313325e14d3ff0c34b6e2c390d1944cbfe150f4457168")
    let to_public = PublicKey.fromStringOrThrow("DWB7vbxtK1WaZqXsiCHPcjVFBewVj8HFRd5Z5XZDpN6Pvb2dZcMqK")
    ...
    it("child from public", ()=> assert.equal(
        ...
        "DWB6XA72XARQCain961PCJnXiKYdEMrndNGago2PV5bcUiVyzJ6iL",
